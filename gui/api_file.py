...
if rome_responce.status_code == 200:    
    ...
    rome_max = rome_main_data['temp_max']
    rome_min = rome_main_data['temp_min']
...
if london_responce.status_code == 200:    
    ...
    london_max = london_main_data['temp_max']
    london_min = london_main_data['temp_min']
...
if warsaw_responce.status_code == 200:    
    ...
    warsaw_max = warsaw_main_data['temp_max']
    warsaw_min = warsaw_main_data['temp_min']
...
if prague_responce.status_code == 200:    
    ...
    prague_max = prague_main_data['temp_max']
    prague_min = prague_main_data['temp_min']
...
def refresh_in_widget(tempritureStatus):
    pass
    # api_key = 'ac90bee491d306ada1c92f65cd9f3482'
